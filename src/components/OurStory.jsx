...
const OurStory = () => {
  ...
  return (
    <>
    {isModalOpen && <StoryModal who={who} onClose={() => setIsModalOpen(false)} />}
    {/* <StoryModal/> */}
    <div className="w-full min-h-[100vh] flex flex-col items-center pt-[5vh] px-[10px] md:pt-[15vh] md:px-[100px] h-auto mb-[120vh] md:mb-[15vh]">
        <div className="flex flex-col gap-6 items-center">
            ...
            <div className="w-full h-[100vh] flex justify-center md:flex-nowrap flex-wrap">
                <div className="w-full h-full flex flex-col items-center gap-0 md:gap-7 md:w-[35%]">
                    ...
                    />
                    <div className="w-[90%] flex flex-col gap-4 min-w-[280px] md:w-[80%]" onClick={()=>handleViewMoreClick(1)}>
                        ...
                        ...</p>
                        <p className="text-[#6A4843] font-semibold cursor-pointer" onClick={()=>handleViewMoreClick(1)}>VIEW MORE</p>
                    </div>
                </div>
                ...
                <div className="w-full h-full flex flex-col items-center gap-0 md:gap-7 md:w-[35%]">
                    <motion.img 
                      ...
                      viewport={{ once: false }}
                    />
                    <div className="w-[90%] flex flex-col gap-4 min-w-[280px] md:w-[80%]" onClick={()=>handleViewMoreClick(2)}>
                        ...
                        ...</p>
                        <p className="text-[#6A4843] font-semibold cursor-pointer" onClick={()=>handleViewMoreClick(2)}>VIEW MORE</p>
                    </div>
                </div>
            </div>
            <div></div>
